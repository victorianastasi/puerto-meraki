            ...
            return(
                <div className="container-fluid body-bg body-checkout">
                    <div className="success-shop">
                        ...
                        <Link to='/' className="btn btn-light btn-form mt-2">Ir al inicio</Link>
                    </div>
                </div>
            )
        }
        ...
        return(
            <div className="body-bg">
                <div className="checkout-empty">
                    <p className="checkout-empty-text">No hay productos en tu carrito de compras </p>
                    <Link to="/" className=" btn btn-dark checkout-empty-button">Ver los productos</Link>
                </div>
            </div>
        )
    }else{
            ...
            <div className="container-fluid body-bg checkout-container">
                ...
                {alertData && 
                    <div className="alert alert-danger alert-data">
                        ...
                        <p className="mb-1 alert-data-text-fields">Nombre, Correo electrónico y Teléfono</p> 
                    </div>
                }
            </div>
        )
